...
describe('tests for /booking-references/{id}', function() {
    describe('tests for delete', function() {
        it('should respond 201 for "OK, bookingReference removed successfully"', function() {
            var response = request('delete', 'http://localhost:3002/booking-references/25868991', { 
        ...
        it('should respond 400 for "Bad request. BookingReference id is invalid."', function() {
            var response = request('delete', 'http://localhost:3002/booking-references/48483303', { 
        ...
        it('should respond 401 for "Authorization information is missing or invalid."', function() {
            var response = request('delete', 'http://localhost:3002/booking-references/24006639', { 
    ...
    describe('tests for get', function() {
        it('should respond 200 for "OK"', function() {
            var response = request('get', 'http://localhost:3002/booking-references/-79794', { 
        ...
        it('should respond 401 for "Authorization information is missing or invalid."', function() {
            var response = request('get', 'http://localhost:3002/booking-references/-70831437', { 
        ...
        it('should respond 404 for "BookingReference was not found"', function() {
            var response = request('get', 'http://localhost:3002/booking-references/-79558694', { 
                'qs': {"apiKey":"ullamco"},
                'time': true
            });
    ...
    describe('tests for patch', function() {
        it('should respond 201 for "OK, BookingReference edited successfully"', function() {
            var response = request('patch', 'http://localhost:3002/booking-references/-87538378', { 
        ...
        it('should respond 400 for "Bad request. BookingReference body is invalid."', function() {
            var response = request('patch', 'http://localhost:3002/booking-references/-6937391', { 
        ...
        it('should respond 401 for "Authorization information is missing or invalid."', function() {
            var response = request('patch', 'http://localhost:3002/booking-references/72783198', { 
